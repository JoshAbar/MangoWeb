...
namespace Mango.Web.Controllers
{
    public class OrderController : Controller
    {
        ...
        {
            await PublishUpdateOrderStatusRequest(orderId, SD.Status_ReadyForPickup);
        ...
        {
            await PublishUpdateOrderStatusRequest(orderId, SD.Status_Completed);
            var response = new ResponseDto();
            if (response != null && response.IsSuccess)
            {
                TempData["success"] = "Status updated successfully";
        ...
        {
            await PublishUpdateOrderStatusRequest(orderId, SD.Status_Cancelled);
            var response = new ResponseDto();
            if (response != null && response.IsSuccess)
            {
                TempData["success"] = "Status updated successfully";
        ...
        private async Task PublishUpdateOrderStatusRequest(int orderId, string status)
        {
            var topicClient = new TopicClient(connectionString, updateOrderStatusTopic);
            try
            {
