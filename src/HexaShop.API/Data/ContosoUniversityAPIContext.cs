using HexaShop.API.Models;
using Microsoft.EntityFrameworkCore;

namespace HexaShop.API.Data
{
    public class HexaShopAPIContext : DbContext
    {
        public HexaShopAPIContext (DbContextOptions<HexaShopAPIContext> options) : base(options)
        {
        }
